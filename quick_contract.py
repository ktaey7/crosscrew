"""Generate a compact host-neutral calling card from runtime enums."""
...
RECOVERY = {
    ...
    'completed': 'Read and verify the referenced result.',
    'failed': 'Read the failure envelope or detail.',
...
Codex optional --effort <{efforts}> is an adapter allowlist, not proof of model support.
